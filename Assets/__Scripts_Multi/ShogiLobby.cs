...
public class ShogiLobby : MonoBehaviourPunCallbacks
{
	...
	public override void OnConnectedToMaster()
	{
		...
		if (isConnecting)
		{
			...
			Debug.Log("<Pun Shogi Launcher>: OnConnectedToMaster() was called by PUN. Now this client is connected and could join a room.\n Calling: PhotonNetwork.JoinRandomRoom(); Operation will fail if no room found");
	...
	public override void OnJoinRandomFailed(short returnCode, string message)
	{
		...
		Debug.Log("<Pun Shogi Launcher>:OnJoinRandomFailed() was called by PUN. No random room available, so we create one.\nCalling: PhotonNetwork.CreateRoom");
	...
	public override void OnDisconnected(DisconnectCause cause)
	{
		...
		Debug.LogError("<Pun Shogi Launcher>:Disconnected");
